...
class Plot:
	...
	def aux_cancel(self):
		os.system('rosrun map_server map_saver -f /home/matias/catkin_ws/src/drl_agent/tests/map_'+str(self.umbral)+'_'+str(rospy.Time.now()))
		...
		#plt.savefig('/home/matias/catkin_ws/src/advanced_agent/simulations/plot/plot_entropy_'+str(self.umbral)+'_'+str(rospy.Time.now())+'.png')
		plt.savefig('/home/matias/catkin_ws/src/drl_agent/tests/plot_entropy_'+str(self.umbral)+'_'+str(rospy.Time.now())+'.png')
		#os.system('rosrun map_server map_saver -f /home/matias/catkin_ws/src/advanced_agent/simulations/map/map_'+str(self.umbral)+'_'+str(rospy.Time.now()))
