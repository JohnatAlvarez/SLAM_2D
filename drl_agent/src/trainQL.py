...
if __name__ == '__main__':
    ...
    highest_reward = 0
    rewardPublisher = rospy.Publisher('/pub/cumulatedReward', Int16, queue_size=10000)
    ...
    for x in range(nepisodes):
        ...
        for i in range(nsteps):
            ...
            rospy.logwarn("reward: " + str(reward) + "acum: " + str(acum))
            acum = acum + reward
            if not (done):
            ...
            #rospy.logwarn(qlearn.returnSize())
        ...
        cumulatedRewardI = Int16()
        cumulatedRewardI.data = cumulated_reward
        rewardPublisher.publish(cumulatedRewardI)
        #rospy.logerr("cumultaed rewarDDD: " + str(cumulatedRewardI.data))
